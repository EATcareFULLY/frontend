...
jest.mock('../../components/label/LabelCameraPermissions', () => (props) => <h1>LabelCameraPermissions</h1>);
jest.mock('../../components/label/LabelCameraCapture', () => (props) => <h1>LabelCameraCapture</h1>);
jest.mock('../../components/label/LabelImage', () => (props) => <h1>LabelImage</h1>);
jest.mock('../../components/label/LabelImageCrop', () => (props) => <h1>LabelImageCrop</h1>);
jest.mock('../../components/label/LabelForm', () => (props) => <h1>LabelForm</h1>);
jest.mock('../../components/label/CameraComponentsWrapper', () => ({ children }) => (
    <div>
