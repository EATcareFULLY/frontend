...
jest.mock("../../components/achievements/AchievementCard", () => ({ name, level, description }) => (
    <div>{`AchievementCard: ${name}, ${level}, ${description}`}</div>
));
jest.mock("../../components/achievements/AchievementLockedCard", () => () => <div>AchievementLockedCard</div>);
