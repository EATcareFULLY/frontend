...
jest.mock("../../components/LeaderboardHeader", () => () => <div>LeaderboardHeader</div>);
jest.mock("../../components/LeaderboardRow", () => ({ position, username, score }) => (
    <div>{`LeaderboardRow: ${position}, ${username}, ${score}`}</div>
));
jest.mock("../../components/LeaderboardDivider", () => () => <div>Divider</div>);
jest.mock("../../components/LeaderboardSearchBar", () => ({ onSearch, onReset }) => (
    <div>
        <button onClick={() => onSearch("testuser")}>Search</button>
        <button onClick={onReset}>Reset</button>
    </div>
));
jest.mock("../../components/LeaderboardRules", () => () => <div>LeaderboardRules</div>);
