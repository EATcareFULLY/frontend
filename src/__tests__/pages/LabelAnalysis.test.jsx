...
jest.mock("../../components/labelanalysis/LabelSubmitted", () => ({ image, text }) => (
    <div>
        <img alt="Submitted label" src={image} />
        <p>{text}</p>
    </div>
));
jest.mock("../../components/labelanalysis/LabelAnalysisDisplay", () => ({ analysis, additives }) => (
    <div>
        <p>{analysis}</p>
        <ul>
...
jest.mock("../../components/label/LabelButtonsWrapper", () => ({ children }) => <div>{children}</div>);
