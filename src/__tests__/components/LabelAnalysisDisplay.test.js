...
jest.mock("../../components/LabelAnalysisTextField", () => ({ title, value }) => (
    <div data-testid="text-field">
        <strong>{title}:</strong> {value}
    </div>
));

jest.mock("../../components/LabelAnalysisBooleanField", () => ({ title, value }) => (
    <div data-testid="boolean-field">
        <strong>{title}:</strong> {value}
    </div>
));

jest.mock("../../components/LabelAnalysisTableField", () => ({ additives }) => (
